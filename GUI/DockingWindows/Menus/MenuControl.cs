...
namespace ARMSim.GUI.DockingWindows.Menus
{
    ...
    [Designer(typeof(ARMSim.GUI.DockingWindows.Menus.MenuControlDesigner))]
    public class MenuControl : ContainerControl, IMessageFilter
    {
        ...
        static MenuControl()
        {
            ...
            _menuImages = ResourceHelper.LoadBitmapStrip(Type.GetType("ARMSim.Menus.MenuControl"),
                                                         "ARMSim.Resources.ImagesMenuControl.bmp",
        ...
        internal void OnWM_MOUSEDOWN(DockingWindows.Win32.POINT screenPos)
        {
        ...
        internal void OnWM_MOUSEMOVE(DockingWindows.Win32.POINT screenPos)
        {
            // Convert the mouse position to screen coordinates
            User32.ScreenToClient(this.Handle, ref screenPos);
...
//							Console.WriteLine("Loop {0} {1}", this.Handle, ((Win32.Msgs)msg.message).ToString());
		...
		protected bool ProcessInterceptedMessage(ref DockingWindows.Win32.MSG msg)
		{
			bool eat = false;
