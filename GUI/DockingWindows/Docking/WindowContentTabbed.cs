...
namespace ARMSim.GUI.DockingWindows.Docking
{
    ...
    public class WindowContentTabbed : WindowContent, IHotZoneSource, IMessageFilter
    {
        ...
        protected ARMSim.GUI.DockingWindows.Controls.TabControl _tabControl;
            ...
            : base(manager, vs)
        {
            ...
            _tabControl = new ARMSim.GUI.DockingWindows.Controls.TabControl();

            // It should always occupy the remaining space after all details
            _tabControl.Dock = DockStyle.Fill;

            // Show tabs only if two or more tab pages exist
            _tabControl.HideTabsMode = ARMSim.GUI.DockingWindows.Controls.TabControl.HideTabsModes.HideUsingLogic;
            ...
            _tabControl.DoubleClickTab += new ARMSim.GUI.DockingWindows.Controls.TabControl.DoubleClickTabHandler(OnDoubleClickTab);
        ...
        public Content CurrentContent
        {
            get
            {
                ARMSim.GUI.DockingWindows.Controls.TabPage tp = _tabControl.SelectedTab;
		...
		public ARMSim.GUI.DockingWindows.Controls.TabControl TabControl
		{
		...
		public override void BringContentToFront(Content c)
		{
            ...
            foreach(ARMSim.GUI.DockingWindows.Controls.TabPage page in _tabControl.TabPages)
                if (page.Tag == c)
                {
        ...
        protected override void OnContentInserted(int index, object value)
        {
            ...
            ARMSim.GUI.DockingWindows.Controls.TabPage newPage = new ARMSim.GUI.DockingWindows.Controls.TabPage();
		...
		protected void OnDoubleClickTab(ARMSim.GUI.DockingWindows.Controls.TabControl tc, ARMSim.GUI.DockingWindows.Controls.TabPage page)
		{
        ...
        protected void OnPageDragStart(object sender, MouseEventArgs e)
        {
            if (this.RedockAllowed)
            {
                ...
                ARMSim.GUI.DockingWindows.Controls.TabPage page = _tabControl.SelectedTab;
