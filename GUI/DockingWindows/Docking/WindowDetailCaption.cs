...
//                }
    ...
    public class WindowDetailCaptionPlain : WindowDetailCaption
    {
        ...
        static WindowDetailCaptionPlain()
        {
            ...
            _images = ResourceHelper.LoadBitmapStrip(Type.GetType("ARMSim.Docking.WindowDetailCaptionPlain"),
                                                     "ARMSim.Resources.ImagesCaptionPlain.bmp",
    ...
    public class WindowDetailCaptionIDE : WindowDetailCaption
    {
        ...
        {
            // Create a strip of images by loading an embedded bitmap resource
            _images = ResourceHelper.LoadBitmapStrip(Type.GetType("ARMSim.GUI.DockingWindows.Docking.WindowDetailCaptionIDE"),
                                                     "ARMSim.GUI.DockingWindows.Resources.ImagesCaptionIDE.bmp",
                                                     new Size(_imageWidth, _imageHeight),
                                                     new Point(0,0));
        }
