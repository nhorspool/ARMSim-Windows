...
namespace ARMSim.GUI.DockingWindows.Docking
{
    ...
    public class TabStub : UserControl
    {
		private class DrawTab
		{
            ...
            protected ARMSim.GUI.DockingWindows.Controls.TabPage _tabPage;

			public DrawTab(ARMSim.GUI.DockingWindows.Controls.TabPage tabPage, Rectangle drawRect, int index)
			{
				_index = index;
				_tabPage = tabPage;
				_drawRect = drawRect;
			...
			public ARMSim.GUI.DockingWindows.Controls.TabPage TabPage  { get { return _tabPage; } }
        ...
        protected void OnInsertedPage(int index, object value)
		{
			...
			ARMSim.GUI.DockingWindows.Controls.TabPage page = value as ARMSim.GUI.DockingWindows.Controls.TabPage;
		...
		protected void OnContentChanged(Content obj, Content.Property prop)
		{
			...
			foreach(ARMSim.GUI.DockingWindows.Controls.TabPage page in _tabPages)
			{
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
			...
			using(Pen borderPen = new Pen(ControlPaint.LightLight(this.ForeColor)))
			{
				...
				foreach(DrawTab dt in _drawTabs)
				{
					...
					ARMSim.GUI.DockingWindows.Controls.TabPage page = dt.TabPage;
