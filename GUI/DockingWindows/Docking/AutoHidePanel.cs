    ...
    public class AutoHidePanel : Panel, IMessageFilter
	{
        ...
        protected TabStub TabStubForContent(Content c)
        {
            ...
            foreach(TabStub ts in this.Controls)
            {
                ...
                foreach(ARMSim.GUI.DockingWindows.Controls.TabPage page in ts.TabPages)
                {
        ...
        public void AddContentIntoTabStub(Content content, TabStub ts, int index)
        {
            ...
            ARMSim.GUI.DockingWindows.Controls.TabPage page = new ARMSim.GUI.DockingWindows.Controls.TabPage();
        ...
        public void AddContentsAsGroup(ContentCollection contents, int index)
		{
            ...
            wct.TabControl.HideTabsMode = ARMSim.GUI.DockingWindows.Controls.TabControl.HideTabsModes.HideAlways;
        ...
        public void RemoveContent(Content c)
        {
            ...
            ARMSim.GUI.DockingWindows.Controls.TabPage targetPage = null;
