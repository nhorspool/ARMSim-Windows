...
using ARMSim.GUI.DockingWindows.Docking;
...
namespace ARMSim.GUI.DockingWindows.Docking
{
    ...
    public class DockingManager
    {
		...
		public delegate void TabControlCreatedHandler(ARMSim.GUI.DockingWindows.Controls.TabControl tabControl);
		public delegate void SaveCustomConfigHandler(XmlWriter xmlOut);
...
//			SaveConfigToFile(filename, Encoding.UTF7);
		...
		public void SaveConfigToFile(string filename, Encoding encoding)
		{
            ...
            {
                System.Diagnostics.Debug.WriteLine(string.Format("Error writing layout file to:{0} Reason:{1}", filename, ex.Message));
            }
            finally
            {
                // Must remember to close
		...
		public void SaveConfigToStream(Stream stream, Encoding encoding)
		{
            ...
            XmlWriter xmlOut = XmlWriter.Create(stream, settings); 
			
			// Always begin file with identification and warning
			xmlOut.WriteStartDocument();
			xmlOut.WriteComment(" ARMSimulator layout settings file. ");
            xmlOut.WriteComment(" University of Victoria, Department of computer science. ");
		...
		public virtual void OnTabControlCreated(ARMSim.GUI.DockingWindows.Controls.TabControl tabControl)
		{ 
		...
		public virtual void OnSaveCustomConfig(XmlWriter xmlOut)
		{
