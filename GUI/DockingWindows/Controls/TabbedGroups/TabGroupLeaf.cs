...
using ARMSim.GUI.DockingWindows.Menus;
...
namespace ARMSim.GUI.DockingWindows.Controls
{
	public class TabGroupLeaf : TabGroupBase
	{
        ...
        static TabGroupLeaf()
        {
            ...
            _internalImages = ResourceHelper.LoadBitmapStrip(Type.GetType("ARMSim.GUI.DockingWindows.Controls.TabbedGroups"),
                                                             "ARMSim.Resources.ImagesTabbedGroups.bmp",
        ...
        public override void Notify(NotifyCode code)
        {
            switch(code)
            {
                ...
                case NotifyCode.DisplayTabMode:
                    ...
                    {
                        case ARMSim.GUI.DockingWindows.Controls.TabbedGroups.DisplayTabModes.ShowAll:
                            _tabControl.HideTabsMode = ARMSim.GUI.DockingWindows.Controls.TabControl.HideTabsModes.ShowAlways;
                            break;
                        case ARMSim.GUI.DockingWindows.Controls.TabbedGroups.DisplayTabModes.HideAll:
                            _tabControl.HideTabsMode = ARMSim.GUI.DockingWindows.Controls.TabControl.HideTabsModes.HideAlways;
                            break;
                        case ARMSim.GUI.DockingWindows.Controls.TabbedGroups.DisplayTabModes.ShowActiveLeaf:
                            _tabControl.HideTabsMode = (_tabbedGroups.ActiveLeaf == this ? ARMSim.GUI.DockingWindows.Controls.TabControl.HideTabsModes.ShowAlways :
                                                                                           ARMSim.GUI.DockingWindows.Controls.TabControl.HideTabsModes.HideAlways);
                            break;
                        case ARMSim.GUI.DockingWindows.Controls.TabbedGroups.DisplayTabModes.ShowMouseOver:
                            _tabControl.HideTabsMode = ARMSim.GUI.DockingWindows.Controls.TabControl.HideTabsModes.HideWithoutMouse;
                            break;
                        case ARMSim.GUI.DockingWindows.Controls.TabbedGroups.DisplayTabModes.ShowActiveAndMouseOver:
                            _tabControl.HideTabsMode = (_tabbedGroups.ActiveLeaf == this ? ARMSim.GUI.DockingWindows.Controls.TabControl.HideTabsModes.ShowAlways :
                                                                                           ARMSim.GUI.DockingWindows.Controls.TabControl.HideTabsModes.HideWithoutMouse);
                            break;
                    }
                    break;
            }
