...
namespace ARMSim.GUI.DockingWindows.Controls
{
    ...
    public class TabbedGroups : UserControl, ISupportInitialize, IMessageFilter
	{
        ...
        public delegate void GlobalSavingHandler(TabbedGroups tg, XmlWriter xmlOut);
        ...
        public virtual void OnTabControlCreated(Controls.TabControl tc)
        {
            ...
            tc.Appearance = ARMSim.GUI.DockingWindows.Controls.TabControl.VisualAppearance.MultiDocument;
            tc.BoldSelectedPage = false;
            ...
            switch(_displayTabMode)
            {
                case TabbedGroups.DisplayTabModes.ShowAll:
                    tc.HideTabsMode = ARMSim.GUI.DockingWindows.Controls.TabControl.HideTabsModes.ShowAlways;
                    break;
                case TabbedGroups.DisplayTabModes.HideAll:
                    tc.HideTabsMode = ARMSim.GUI.DockingWindows.Controls.TabControl.HideTabsModes.HideAlways;
                    break;
            }
        ...
        public virtual void OnGlobalSaving(XmlWriter xmlOut)
        {
            // Has anyone registered for the event?
