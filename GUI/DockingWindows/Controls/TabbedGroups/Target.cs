...
namespace ARMSim.GUI.DockingWindows.Controls
{
	...
	public class TargetManager
	{
	    ...
	    {
            _validCursor = ResourceHelper.LoadCursor(Type.GetType("ARMSim.Controls.TabbedGroups"),
                                                                  "ARMSim.Resources.TabbedValid.cur");

            _invalidCursor = ResourceHelper.LoadCursor(Type.GetType("ARMSim.Controls.TabbedGroups"),
                                                                    "ARMSim.Resources.TabbedInvalid.cur");
        }
