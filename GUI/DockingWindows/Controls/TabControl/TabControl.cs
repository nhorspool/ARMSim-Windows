...
namespace ARMSim.GUI.DockingWindows.Controls
{
    ...
    [Designer(typeof(ARMSim.GUI.DockingWindows.Controls.TabControlDesigner))]
    public class TabControl : Panel
    {
        ...
        static TabControl()
        {
            ...
            _internalImages = ResourceHelper.LoadBitmapStrip(Type.GetType("ARMSim.GUI.DockingWindows.Controls.TabControl"),
                                                             "ARMSim.GUI.DockingWindows.Resources.ImagesTabControl.bmp",
